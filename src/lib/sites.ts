...
export const SITES = {
  ...
  webgpudna: {
    ...
    stats: [
      { value: "0.985×", label: "CSDA vs Geant4-DNA" },
      { value: "1.00×", label: "ions/primary vs Geant4" },
      { value: "100%", label: "energy conservation" },
      { value: "46/46", label: "unit tests pass" },
    ],
  ...
  zerotvm: {
    ...
    domain: "zerotvm.com",
    name: "zerotvm.com",
    tagline: "Phi-3-mini in the browser — 10 hand-written kernels, no compiler.",
    shortDesc:
  ...
  gpubench: {
    ...
    stats: [
      { value: "92", label: "unique devices" },
      { value: "210", label: "transformer runs" },
